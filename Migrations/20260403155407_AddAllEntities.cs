        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActionPlans_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ActionPlans_Processes_ProcessId",
                        column: x => x.ProcessId,
                        principalTable: "Processes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActionPlans_Users_PilotId",
                        column: x => x.PilotId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnomalyDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActionDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Criticity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Cause = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProgressPercentage = table.Column<double>(type: "float", nullable: false),
                    Deadline = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RealizationMethod = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    EffectivenessComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActionItems_ActionPlans_ActionPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_ActionItems_ActionItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationLogs_ActionItems_ActionItemId",
                        column: x => x.ActionItemId,
                        principalTable: "ActionItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionItems_ActionPlanId",
                table: "ActionItems",
                column: "ActionPlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionPlans_DepartmentId",
                table: "ActionPlans",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ActionPlans_PilotId",
                table: "ActionPlans",
                column: "PilotId");

            migrationBuilder.CreateIndex(
                name: "IX_ActionPlans_ProcessId",
                table: "ActionPlans",
                column: "ProcessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_ActionItemId",
                table: "Attachments",
                column: "ActionItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_ActionItemId",
